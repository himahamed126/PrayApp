            ...
            switch (mShapeType) {
                ...
                case 4:
                    ...
                    if (borderWidth > 0) {
                        ...
                        path.cubicTo(5 * getWidth() / 14, 0, 0, getHeight() / 15, getWidth() / 28, 2 * getHeight() / 5);

                        path.cubicTo(getWidth() / 14, 2 * getHeight() / 3, 3 * getWidth() / 7, 5 * getHeight() / 6, getWidth() / 2, getHeight());

                        path.cubicTo(4 * getWidth() / 7, 5 * getHeight() / 6, 13 * getWidth() / 14, 2 * getHeight() / 3, 27 * getWidth() / 28, 2 * getHeight() / 5);

                        path.cubicTo(getWidth(), getHeight() / 15, 9 * getWidth() / 14, 0, getWidth() / 2, getHeight() / 5);
